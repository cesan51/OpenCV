...
while True:
    ...
    ret, frame = cap.read()
    # ret: Esta variable booleana es True cuando SÍ se ha capturado una imagen,
    # mientras que es False cuando NO se ha capturado una imagen con la cual trabajar
    ...
    # Desenfoque
        ...
        # Modificamos frames
        resultado = cv2.blur(frame, (13, 13)) # Nivel de desenfoque
    ...
    # Esquinas
        ...
        esquinas = cv2.goodFeaturesToTrack(gray, **esquinas_param)  # Al utilizar parametros **
